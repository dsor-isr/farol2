...
class RPMConversion : public rclcpp::Node {
  ...
  private:
    ...
    rclcpp::Subscription<farol2_allocation::msg::ThrusterForce>::SharedPtr thruster_force_sub_;
    ...
    /* Callbacks */
    void thrusterForceCallback(farol2_allocation::msg::ThrusterForce::SharedPtr msg);
