...
/**
 * @brief Path following using Breivik's algorithm for path following
 * Method4: based on the work of Breivik and Fossen (2005) 
 ...
 * @copyright MIT
 */
class Breivik : public PathFollowing {
  ...
  public:
     ...
     * @param delta_h Gain for the Breivik controller
     */
    Breivik(rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr surge_pub, 
  ...
  private:
    ...
    /**
     * @brief Breivik controller gains
     */
    double delta_h_;
};
