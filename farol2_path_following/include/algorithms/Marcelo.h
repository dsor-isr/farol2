...
class Marcelo : public PathFollowing {
  ...
  public:
     ...
     */
    Marcelo(double delta, double kk[2], double kz, double k_pos, double k_currents, double rd[3], double d[3], 
  ...
  private:
    ...
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr rabbit_pub_;
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr currents_estimation_x_pub_;
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr currents_estimation_y_pub_;
};
