...
#include "farol2_path_following/srv/reset_vt.hpp"
#include "farol2_path_following/srv/set_pf.hpp"
#include "farol2_path_following/srv/start_pf.hpp"
#include "farol2_path_following/srv/stop_pf.hpp"
#include "farol2_path_following/srv/update_gains_pf.hpp"
...
class PathFollowingNode : public rclcpp::Node {
  ...
  private:
     ...
     */
    rclcpp::Service<farol2_path_following::srv::StartPF>::SharedPtr pf_start_srv_;
    rclcpp::Service<farol2_path_following::srv::StopPF>::SharedPtr pf_stop_srv_;
    rclcpp::Service<farol2_path_following::srv::UpdateGainsPF>::SharedPtr pf_update_gains_srv_;

    rclcpp::Service<farol2_path_following::srv::SetPF>::SharedPtr pf_aguiar_srv_;
    rclcpp::Service<farol2_path_following::srv::SetPF>::SharedPtr pf_breivik_srv_;
    rclcpp::Service<farol2_path_following::srv::SetPF>::SharedPtr pf_fossen_srv_;
    ...
    rclcpp::Service<farol2_path_following::srv::SetPF>::SharedPtr pf_ilos_srv_;

    /* Service to reset the virtual target position */
    rclcpp::Service<farol2_path_following::srv::ResetVT>::SharedPtr pf_reset_vt_srv_;
    ...
    /**
     * @brief Method to stop the current farol2_path_following 
     */
    void stopAlgorithm();
    ...
    void StartPFService(const std::shared_ptr<farol2_path_following::srv::StartPF::Request> req,
                        std::shared_ptr<farol2_path_following::srv::StartPF::Response> res);

    void StopPFService(const std::shared_ptr<farol2_path_following::srv::StopPF::Request> req,
                        std::shared_ptr<farol2_path_following::srv::StopPF::Response> res);

    void ResetVirtualTargetService(const std::shared_ptr<farol2_path_following::srv::ResetVT::Request> req,
                                   std::shared_ptr<farol2_path_following::srv::ResetVT::Response> res);
    
    void UpdateGainsPFService(const std::shared_ptr<farol2_path_following::srv::UpdateGainsPF::Request> req,
                              std::shared_ptr<farol2_path_following::srv::UpdateGainsPF::Response> res);

    
    void SetRelativeHeadingService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                                   std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetMarceloService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                           std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetAguiarService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                          std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetBreivikService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                          std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetFossenService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                          std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetRomuloService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                          std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);

    void SetLapierreService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                            std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);
    ...
    void SetIlosService(const std::shared_ptr<farol2_path_following::srv::SetPF::Request> req,
                        std::shared_ptr<farol2_path_following::srv::SetPF::Response> res);
