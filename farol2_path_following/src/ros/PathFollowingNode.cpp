 ...
 * the path
 */
void PathFollowingNode::pathStateCallback(const farol2_planning::msg::PathData &msg) {
...
void PathFollowingNode::vehicleStateCallback(const farol2_interfaces::msg::NavigationState &msg) {
  ...
  this->vehicle_state_.vc_inertial << msg.current_velocity_ned.x,
                                      msg.current_velocity_ned.y,
                                      msg.current_velocity_ned.z;
}
...
void PathFollowingNode::sendWaypoint(double value) {
  std::shared_ptr<farol2_waypoint::srv::SendWpType1::Request> req = std::make_shared<farol2_waypoint::srv::SendWpType1::Request>();
