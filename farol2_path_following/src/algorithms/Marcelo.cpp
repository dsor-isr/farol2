...
Marcelo::Marcelo(double delta, double kk[2], double kz, double k_pos, double k_currents, double rd[3], double d[3], 
                 ...
                 rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr currents_estimation_x_pub, 
                 rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr currents_estimation_y_pub) {
...
void Marcelo::publish_private(){
  ...
  msg.data = this->desired_yaw_rate_ / 180 * M_PI;
  ...
  msg.data = this->currents_hat_[0];
  this->currents_estimation_x_pub_->publish(msg);

  msg.data = this->currents_hat_[1];
  this->currents_estimation_y_pub_->publish(msg);
}
