...
def generate_launch_description():
  ...
  path_following_node = Node(
    ...
    remappings=[
      ...
      ('rabbit', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/gamma')]),
      ...
      ('pfollowing_debug', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/debug')]),
      # Services
      # Service names to start and stop the path following algorithm
      ('start_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/Start')]),
      ('stop_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/Stop')]),
      ('update_gains_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/UpdateGains')]),
      ('reset_vt_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/ResetVT')]),
          # Service names to switch the path following algorithm
      ('marcelo_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetMarcelo')]),
      ('aguiar_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetAguiar')]),
      ('breivik_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetBreivik')]),
      ('fossen_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetFossen')]),
      ('romulo_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetRomulo')]),
      ('lapierre_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetLapierre')]),
      ('pramod_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetPramod')]),
      ('ravi_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetRavi')]),
      ('samson_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetSamson')]),
      ('ilos_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetIlos')]),
      ('relative_heading_pf', [TextSubstitution(text='/'), vehicle_ns, TextSubstitution(text='/control/path_following/SetRelativeHeading')]),
