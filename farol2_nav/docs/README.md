...
- publish the navigation state to a topic with the ROS message `farol2_interfaces::msg::NavigationState`;
...
- add the new node to the navigation launch file under `farol2_bringup/launch/nav.launch.py`, similarly to the other algorithms' nodes.
