 ...
 */
PathNode::PathNode() : Node("farol2_paths") {
...
void PathNode::initializePublishers() {	  
  this->path_pub_ = create_publisher<farol2_paths::msg::PathData>(
...
void PathNode::timerCallback() {
  ...
  farol2_paths::msg::PathData msg; 
  farol2_interfaces::msg::StateConsole vt_state_msg;
