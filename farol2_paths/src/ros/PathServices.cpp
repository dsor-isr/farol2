...
void PathNode::initializeServices() {
  this->reset_path_srv_ = create_service<farol2_paths::srv::ResetPath>(
      declare_parameter<std::string>("topics.services.reset_path"),
      [this](const std::shared_ptr<farol2_paths::srv::ResetPath::Request> request,
        std::shared_ptr<farol2_paths::srv::ResetPath::Response> response){
        ResetPathService(request, response);});

  this->set_mode_srv_ = create_service<farol2_paths::srv::SetMode>(
      declare_parameter<std::string>("topics.services.set_mode"),
      [this](const std::shared_ptr<farol2_paths::srv::SetMode::Request> request,
        std::shared_ptr<farol2_paths::srv::SetMode::Response> response){
        SetModeService(request, response);});
  
  this->arc2d_srv_ = create_service<farol2_paths::srv::SpawnArc2D>(
      declare_parameter<std::string>("topics.services.arc2d_path"),
      [this](const std::shared_ptr<farol2_paths::srv::SpawnArc2D::Request> request,
        std::shared_ptr<farol2_paths::srv::SpawnArc2D::Response> response){
        Arc2DService(request, response);});

  this->bernoulli_srv_ = create_service<farol2_paths::srv::SpawnBernoulli>(
      declare_parameter<std::string>("topics.services.bernoulli_path"),
      [this](const std::shared_ptr<farol2_paths::srv::SpawnBernoulli::Request> request,
        std::shared_ptr<farol2_paths::srv::SpawnBernoulli::Response> response){
        BernoulliService(request, response);});
  
  this->circle2D_srv_ = create_service<farol2_paths::srv::SpawnCircle2D>(
      declare_parameter<std::string>("topics.services.circle2d_path"),
      [this](const std::shared_ptr<farol2_paths::srv::SpawnCircle2D::Request> request,
        std::shared_ptr<farol2_paths::srv::SpawnCircle2D::Response> response){
        Circle2DService(request, response);});
  
  this->line_srv_ = create_service<farol2_paths::srv::SpawnLine>(
      declare_parameter<std::string>("topics.services.line_path"),
      [this](const std::shared_ptr<farol2_paths::srv::SpawnLine::Request> request,
        std::shared_ptr<farol2_paths::srv::SpawnLine::Response> response){
        LineService(request, response);});

  this->rabbit_const_speed_srv_ = create_service<farol2_paths::srv::SetConstSpeed>(
      declare_parameter<std::string>("topics.services.speed.const_rabbit_speed"),
      [this](const std::shared_ptr<farol2_paths::srv::SetConstSpeed::Request> request,
        std::shared_ptr<farol2_paths::srv::SetConstSpeed::Response> response){
        RabbitConstSpeedService(request, response);});
  
  this->vehicle_const_speed_srv_ = create_service<farol2_paths::srv::SetConstSpeed>(
...
bool PathNode::ResetPathService(const std::shared_ptr<farol2_paths::srv::ResetPath::Request> req, std::shared_ptr<farol2_paths::srv::ResetPath::Response> res){
  if (req) {;} /* yeñz */
...
bool PathNode::SetModeService(const std::shared_ptr<farol2_paths::srv::SetMode::Request> req, std::shared_ptr<farol2_paths::srv::SetMode::Response> res) {
...
bool PathNode::Arc2DService(const std::shared_ptr<farol2_paths::srv::SpawnArc2D::Request> req, std::shared_ptr<farol2_paths::srv::SpawnArc2D::Response> res){
...
bool PathNode::BernoulliService(const std::shared_ptr<farol2_paths::srv::SpawnBernoulli::Request> req, std::shared_ptr<farol2_paths::srv::SpawnBernoulli::Response> res){
...
bool PathNode::Circle2DService(const std::shared_ptr<farol2_paths::srv::SpawnCircle2D::Request> req, std::shared_ptr<farol2_paths::srv::SpawnCircle2D::Response> res) {
...
bool PathNode::LineService(const std::shared_ptr<farol2_paths::srv::SpawnLine::Request> req, std::shared_ptr<farol2_paths::srv::SpawnLine::Response> res){
...
bool PathNode::RabbitConstSpeedService(const std::shared_ptr<farol2_paths::srv::SetConstSpeed::Request> req, std::shared_ptr<farol2_paths::srv::SetConstSpeed::Response> res) {
...
bool PathNode::VehicleConstSpeedService(const std::shared_ptr<farol2_paths::srv::SetConstSpeed::Request> req, std::shared_ptr<farol2_paths::srv::SetConstSpeed::Response> res) {
