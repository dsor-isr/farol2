...
void MagicElectricSim::initialiseSubscribers()
{
  ...
  rpm_sub_ = create_subscription<farol2_control_allocation::msg::ThrusterRPM>(
...
void MagicElectricSim::rpmCallback(const farol2_control_allocation::msg::ThrusterRPM::SharedPtr msg)
{
