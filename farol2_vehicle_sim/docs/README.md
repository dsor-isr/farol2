...
This package provides simulators for DSOR vehicles. The simulators receive actuator commands and output realistic simulated states to the sensor interfaces. Key features include hydrodynamic current modeling and vehicle-specific actuation simulation.
