...
class MagicElectricSim : public rclcpp::Node {
  ...
  private:
    ...
    rclcpp::Subscription<farol2_control_allocation::msg::ThrusterRPM>::SharedPtr rpm_sub_;
    ...
    void rpmCallback(const farol2_control_allocation::msg::ThrusterRPM::SharedPtr msg);
