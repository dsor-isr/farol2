...
{
  change_filter_srv_ = create_service<farol2_nav_filters::srv::ChangeFilter>(
      declare_parameter<std::string>("topics.services.change_filter"),
      [this](const std::shared_ptr<farol2_nav_filters::srv::ChangeFilter::Request> request,
             std::shared_ptr<farol2_nav_filters::srv::ChangeFilter::Response> response)
      {
...
void FilterHandler::changeFilterCallback(
    const std::shared_ptr<farol2_nav_filters::srv::ChangeFilter::Request> request,
    std::shared_ptr<farol2_nav_filters::srv::ChangeFilter::Response> response)
{
