...
void LowPass::measurement_callback(farol2_interfaces::msg::Measurement::SharedPtr msg) { 
...
void LowPass::timerCallback() {
  ...
  // Compute course angle
  filter_state_msg_.course_angle = farol2_utils::wrapTo2Pi(std::atan2(v_i.y(), v_i.x()));
