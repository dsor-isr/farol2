...
The *farol2_interfaces* package houses all custom ROS messages and services created for the FAROL stack.

| Message    | Description |
| -------- | ------- |
| ProcessState | To be used by the *farol2_bringup* node, containing the internal state of a single process launched by the aforementioned node. |
...
| Service    | Description |
| -------- | ------- |
| ProcessState | To be used by the *farol2_bringup* node, containing the service that handles processes (start, kill, restart, etc.). |