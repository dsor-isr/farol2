...
void RPMConversion::initialiseSubscribers() {
  thruster_force_sub_ = create_subscription<farol2_control_allocation::msg::ThrusterForce>(
    declare_parameter<std::string>("topics.subscribers.thruster_force"),
    rclcpp::QoS(1),
    [this](farol2_control_allocation::msg::ThrusterForce::SharedPtr msg){thrusterForceCallback(msg);});
...
void RPMConversion::initialisePublishers() {
  rpm_command_pub_ = create_publisher<farol2_control_allocation::msg::ThrusterRPM>(
 ...
 */
void RPMConversion::thrusterForceCallback(farol2_control_allocation::msg::ThrusterForce::SharedPtr msg) {
