...
void ThrottleConversion::initialiseSubscribers() {
  rpm_command_sub_ = create_subscription<farol2_control_allocation::msg::ThrusterRPM>(
  declare_parameter<std::string>("topics.subscribers.rpm_command"),
  rclcpp::QoS(1),
  [this](farol2_control_allocation::msg::ThrusterRPM::SharedPtr msg){rpmCommandCallback(msg);});
}
 ...
 */
void ThrottleConversion::rpmCommandCallback(farol2_control_allocation::msg::ThrusterRPM::SharedPtr msg) {
