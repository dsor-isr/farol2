...
class ThrusterRudderAllocation : public rclcpp::Node {
  ...
  private:
    ...
    rclcpp::Publisher<farol2_control_allocation::msg::ThrusterForce>::SharedPtr thruster_force_pub_;
    ...
    farol2_control_allocation::msg::ThrusterForce thruster_force_msg_;
