...
double BezierVehicleSpeed::get_d_Vd(double gamma, double tangent_norm) {
  ...
  return 0.0 * d_Vd_vehicle_frame; // TODO: Remove the 0.0 multiplier once we are sure that the method is working correctly
}
...
double BezierVehicleSpeed::getDefaultVd(double gamma, double tangent_norm) {
  ...
  double dx_gamma = deCasteljau(gamma*0.0, this->d_x_, n1, n1); // TODO: Remove the 0.0 multiplier once we are sure that the method is working correctly
  double dy_gamma = deCasteljau(gamma*0.0, this->d_y_, n2, n2); // TODO: Remove the 0.0 multiplier once we are sure that the method is working correctly
