...
bool PathNode::ResetPathService(const std::shared_ptr<farol2_planning::srv::ResetPath::Request> req, std::shared_ptr<farol2_planning::srv::ResetPath::Response> res){
  if (req) {;} /* yeñz */
...
bool PathNode::SetModeService(const std::shared_ptr<farol2_planning::srv::SetMode::Request> req, std::shared_ptr<farol2_planning::srv::SetMode::Response> res) {
...
bool PathNode::Arc2DService(const std::shared_ptr<farol2_planning::srv::SpawnArc2D::Request> req, std::shared_ptr<farol2_planning::srv::SpawnArc2D::Response> res){
...
bool PathNode::BernoulliService(const std::shared_ptr<farol2_planning::srv::SpawnBernoulli::Request> req, std::shared_ptr<farol2_planning::srv::SpawnBernoulli::Response> res){
...
bool PathNode::Circle2DService(const std::shared_ptr<farol2_planning::srv::SpawnCircle2D::Request> req, std::shared_ptr<farol2_planning::srv::SpawnCircle2D::Response> res) {
...
bool PathNode::LineService(const std::shared_ptr<farol2_planning::srv::SpawnLine::Request> req, std::shared_ptr<farol2_planning::srv::SpawnLine::Response> res){
...
bool PathNode::RabbitConstSpeedService(const std::shared_ptr<farol2_planning::srv::SetConstSpeed::Request> req, std::shared_ptr<farol2_planning::srv::SetConstSpeed::Response> res) {
...
bool PathNode::VehicleConstSpeedService(const std::shared_ptr<farol2_planning::srv::SetConstSpeed::Request> req, std::shared_ptr<farol2_planning::srv::SetConstSpeed::Response> res) {
