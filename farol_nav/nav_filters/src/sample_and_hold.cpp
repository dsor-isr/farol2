...
void SampleAndHold::initialiseSubscribers() {
  ...
  rpm_command_sub_ = create_subscription<control_allocation::msg::ThrusterRPM>(
    ...
    rclcpp::QoS(1),
    [this](control_allocation::msg::ThrusterRPM::ConstSharedPtr msg) { rpm_command_callback(msg); });
 
  return;
}

void SampleAndHold::rpm_command_callback(control_allocation::msg::ThrusterRPM::ConstSharedPtr msg) {
  if (msg->rpm.empty()) {
    return;
  }
