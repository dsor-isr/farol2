...
void Waypoint::stateCallback(farol2_interfaces::msg::NavigationState::SharedPtr msg) {
  ...
  veh_state_.eta2[2] = msg->attitude.yaw; // yaw
  veh_state_.v1[0] = msg->velocity_over_ground.x;
  veh_state_.v1[1] = msg->velocity_over_ground.y;
...
void Waypoint::sendWpStandardService(const std::shared_ptr<farol2_waypoint::srv::SendWpType1::Request> req,
...
void Waypoint::sendWpLooseService(const std::shared_ptr<farol2_waypoint::srv::SendWpType1::Request> req,
                                  std::shared_ptr<farol2_waypoint::srv::SendWpType1::Response> res){
  RCLCPP_INFO(get_logger(), "Sending Waypoint");
  // create pointer to new controller
...
void Waypoint::sendWpHeadingService(const std::shared_ptr<farol2_waypoint::srv::SendWpType1::Request> req,
                                    std::shared_ptr<farol2_waypoint::srv::SendWpType1::Response> res) {
  RCLCPP_INFO(get_logger(), "Sending Waypoint");
  // create pointer to new controller
